...
@section('content')
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="card">
                    <div class="card-header">Change {{ $employee->first_name }} {{ $employee->last_name }} password</div>
                    <div class="card-body">
                        <form class="form-horizontal" action="/employee-edit/{{$employee->id}}/password" method="POST" id="editPassword">
                            @csrf
...
@endsection
@section('script')
    <script type="text/javascript" src="{{ asset('/js/admin/employee/edit-password.js') }}"></script>
@endsection
